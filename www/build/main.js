...
var Select_end_datePage = /** @class */ (function () {
    function Select_end_datePage(navCtrl, http, api) {
        this.navCtrl = navCtrl;
        this.http = http;
        this.api = api;
        this.event = {
    ...
    Select_end_datePage.prototype.home = function () {
        ...
        this.api.selectEndDate(this.trip).subscribe(function (response) { console.log(response); }, function (error) { console.log(error); });
    ...
    Select_end_datePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-select_end_date',template:/*ion-inline-start:"D:\Workspace\gitlab\ebike\frontend\src\pages\select_end_date\select_end_date.html"*/'<ion-header>\n    <ion-navbar>\n        <button ion-button menuToggle>\n            <ion-icon name="menu"></ion-icon>\n        </button>\n        <ion-title>{{\'select_end_date\' | translate}}</ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content class="bg-color">\n    <div class="calendar_box">\n        <ion-calendar #calendar lang="en"></ion-calendar>\n    </div>\n\n    <div class="select_date">\n        <h2>{{\'select_trip_end_time\' | translate}}</h2>\n        <ion-datetime displayFormat="h:mm A" pickerFormat="YYYY-MM-DD HH:mm:ss" [(ngModel)]="trip.endDate"></ion-datetime>\n        <h3>{{\'tab_to_select\' | translate}}</h3>\n    </div>\n</ion-content>\n<ion-footer no-border>\n   <button ion-button  no-margin full class="btn" (click)="home()">{{\'continue\' | translate}}</button>\n</ion-footer>'/*ion-inline-end:"D:\Workspace\gitlab\ebike\frontend\src\pages\select_end_date\select_end_date.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_2__providers_api_ebike_api__["a" /* EbikeApiProvider */]])
    ], Select_end_datePage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__car_list_car_list__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_common_http__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_booking_booking__ = __webpack_require__(347);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    ...
    function HomePage(navCtrl, http, api, book) {
        this.navCtrl = navCtrl;
        this.http = http;
        this.api = api;
        this.book = book;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_common_http__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_booking_booking__ = __webpack_require__(347);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Select_start_datePage = /** @class */ (function () {
    function Select_start_datePage(navCtrl, http, api, booking) {
        this.navCtrl = navCtrl;
        this.http = http;
        this.api = api;
    ...
    Select_start_datePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({
            selector: 'page-select_start_date',template:/*ion-inline-start:"D:\Workspace\gitlab\ebike\frontend\src\pages\select_start_date\select_start_date.html"*/'<ion-header>\n    <ion-navbar>\n        <button ion-button menuToggle>\n            <ion-icon name="menu"></ion-icon>\n        </button>\n        <ion-title>{{\'select_start_date\' | translate}}</ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content class="bg-color">\n    <div class="calendar_box">\n        <ion-calendar #calendar lang="en"></ion-calendar>\n    </div>\n\n    <div class="select_date">\n        <h2>{{\'select_trip_start_time\' | translate}}</h2>\n        <ion-datetime displayFormat="h:mm A" pickerFormat="YYYY-MM-DD HH:mm:ss" [(ngModel)]="trip.startDate">\n        </ion-datetime>\n        <h3>{{\'tab_to_select\' | translate}}</h3>\n    </div>\n</ion-content>\n<ion-footer no-border>\n    <button ion-button no-margin full class="btn" (click)="select_end_date()">{{\'select_end_date\' | translate}}</button>\n</ion-footer>'/*ion-inline-end:"D:\Workspace\gitlab\ebike\frontend\src\pages\select_start_date\select_start_date.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_0__providers_api_ebike_api__["a" /* EbikeApiProvider */], __WEBPACK_IMPORTED_MODULE_5__providers_booking_booking__["a" /* BookingProvider */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_Booking_Booking__ = __webpack_require__(447);
...
var BookingProvider = /** @class */ (function () {
    function BookingProvider(http) {
        this.http = http;
        this.booking = new __WEBPACK_IMPORTED_MODULE_0__models_Booking_Booking__["a" /* Booking */](2, 1);
        this.baseURL = "http://192.168.1.21:3000/api/";
        console.log('------------BookingProvider initiated!---------------');
    }
    BookingProvider.prototype.getCurrentBooking = function () {
        return this.booking;
    };
    BookingProvider.prototype.setStartDate = function (date) {
        this.booking.startDate = date;
    };
    BookingProvider.prototype.submitBooking = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_api_ebike_api__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__book_car_book_car__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__filters_filters__ = __webpack_require__(352);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__payment_payment__ = __webpack_require__(350);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Book_carPage = /** @class */ (function () {
    function Book_carPage(navCtrl) {
        this.navCtrl = navCtrl;
        this.startTrip = __WEBPACK_IMPORTED_MODULE_2_moment___default()('2020-08-05 14:00:00');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__booked_booked__ = __webpack_require__(351);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__doc_verified_doc_verified__ = __webpack_require__(354);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Doc_verifiedPage = /** @class */ (function () {
    ...
    Doc_verifiedPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-doc_verified',template:/*ion-inline-start:"D:\Workspace\gitlab\ebike\frontend\src\pages\doc_verified\doc_verified.html"*/'<ion-header class="theme_header bg-transparent">\n    <ion-navbar>\n        <button ion-button menuToggle>\n            <ion-icon name="menu"></ion-icon>\n        </button>\n        <ion-title>\n            <span class="d-flex">\n                <span>\n                    {{\'your_licence_is\' | translate}}\n                    <br>\n                    <strong>{{\'approved\' | translate}}</strong>\n                </span>\n                <ion-icon class="zmdi zmdi-check-circle end"></ion-icon>\n            </span>\n            <h2> {{\'we_ve_verified_your_lincence\' | translate}}</h2>\n        </ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content>\n    <div class="add_lincence">\n        <ion-scroll scrollX="true">\n            <div class="img_box center_img active">\n                <img src="assets/imgs/l1.png" class="crop_img">\n                <!--                <ion-icon class="zmdi zmdi-plus-circle"></ion-icon>-->\n            </div>\n            <div class="img_box center_img">\n                <img src="assets/imgs/l2.png" class="crop_img">\n                <!--                <ion-icon class="zmdi zmdi-plus-circle"></ion-icon>-->\n            </div>\n        </ion-scroll>\n    </div>\n</ion-content>\n<ion-footer no-border>\n    <div class=\'container\'>\n        <h2 class="d-flex">\n            <ion-icon class="zmdi zmdi-plus-circle"></ion-icon>\n            {{\'add_change_screenshot\' | translate}}\n        </h2>\n        <h2 class="d-flex">\n            <ion-icon class="zmdi zmdi-delete"></ion-icon>\n            {{\'delete_document\' | translate}}\n        </h2>\n    </div>\n</ion-footer>'/*ion-inline-end:"D:\Workspace\gitlab\ebike\frontend\src\pages\doc_verified\doc_verified.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */]])
    ], Doc_verifiedPage);
...
var Terms_conditionPage = /** @class */ (function () {
    ...
    Terms_conditionPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-terms_condition',template:/*ion-inline-start:"D:\Workspace\gitlab\ebike\frontend\src\pages\terms_condition\terms_condition.html"*/'<ion-header class="theme_header bg-transparent">\n    <ion-navbar>\n        <button ion-button menuToggle>\n            <ion-icon name="menu"></ion-icon>\n        </button>\n        <ion-title>{{\'terms_condition\' | translate}}\n            <h2>Companies policies</h2>\n        </ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content>\n    <div class="container">\n        <p>\n            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s,\n        </p>\n        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English.</p>\n        <h2>Terms of use</h2>\n        <p>\n            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s,\n        </p>\n        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English.</p>\n    </div>\n</ion-content>'/*ion-inline-end:"D:\Workspace\gitlab\ebike\frontend\src\pages\terms_condition\terms_condition.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */]])
    ], Terms_conditionPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_api_ebike_api__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sign_up_sign_up__ = __webpack_require__(358);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ngx_translate_http_loader__ = __webpack_require__(430);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ionic3_calendar_en__ = __webpack_require__(432);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__app_component__ = __webpack_require__(438);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_book_car_book_car__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_booked_booked__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_car_list_car_list__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_doc_verificatino_doc_verificatino__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_doc_verified_doc_verified__ = __webpack_require__(354);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_filters_filters__ = __webpack_require__(352);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_payment_payment__ = __webpack_require__(350);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_sign_in_sign_in__ = __webpack_require__(357);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_sign_up_sign_up__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_support_support__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_terms_condition_terms_condition__ = __webpack_require__(355);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_verification_verification__ = __webpack_require__(448);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__providers_providers_sign_in_sign_in_providers_sign_in_sign_in__ = __webpack_require__(449);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__providers_api_ebike_api__ = __webpack_require__(36);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_doc_verificatino_doc_verificatino__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_terms_condition_terms_condition__ = __webpack_require__(355);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_support_support__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_sign_in_sign_in__ = __webpack_require__(357);
...
var Booking = /** @class */ (function () {
    function Booking(hours, bid) {
        this.hours = hours;
        this.bikeId = bid;
    }
    Booking.prototype.getHours = function () {
        return this.hours;
    };
    return Booking;
}());
...
var VerificationPage = /** @class */ (function () {
    ...
    VerificationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-verification',template:/*ion-inline-start:"D:\Workspace\gitlab\ebike\frontend\src\pages\verification\verification.html"*/'<ion-header class="theme_header bg-transparent">\n    <ion-navbar>\n        <ion-title>\n            {{\'verification_code\' | translate}}\n            <h2> {{\'verification_code_massage\' | translate}}</h2>\n        </ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content>\n    <div class="form">\n        <ion-list no-lines>\n            <ion-item class="password">\n                <ion-label class="d-flex">{{\'enter_verification_code\' | translate}}</ion-label>\n                <ion-input type="text" value="5887"></ion-input>\n            </ion-item>\n        </ion-list>\n    </div>\n\n    <button ion-button   no-margin full class="btn" (click)="home()">{{\'sign_up_now\' | translate}}</button>\n</ion-content>\n'/*ion-inline-end:"D:\Workspace\gitlab\ebike\frontend\src\pages\verification\verification.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */]])
    ], VerificationPage);
